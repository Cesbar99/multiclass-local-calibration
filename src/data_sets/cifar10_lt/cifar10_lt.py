...
#_DATA_URL = _DATA_URL = "./data/CIFAR10/cifar-10-python.tar.gz" #"https://www.cs.toronto.edu/~kriz/cifar-10-python.tar.gz"
_DATA_URL = os.path.join(os.path.dirname(__file__), "../../../data/CIFAR10/cifar-10-python.tar.gz")
...
class cifar10_lt(datasets.GeneratorBasedBuilder):
    """CIFAR-10 Dataset"""
